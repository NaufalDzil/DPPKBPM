                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center"><?php if($row->surat): ?>
                        ...
                        <a href="<?php echo e(route('suratmasuk.disposisi', $row->id)); ?>" class="btn btn-outline-primary btn-sm">
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Test\SISMAKE\resources\views\suratmasuk\index.blade.php ENDPATH**/ ?>