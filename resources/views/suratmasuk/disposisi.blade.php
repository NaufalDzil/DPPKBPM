...
<div class="disposisi-container">
    <div class="header">
        <img src="{{asset('storage/foto/logo.png')}}" alt="Logo"> 
    ...
    <div class="content-section">
        <label>Surat dari :</label> <input style="width: 70%;" value="{{$suratmasuk->alamat}}" readonly ></input>
        <label>Nomor Surat :</label> <input style="width: 70%;" value="{{$suratmasuk->nomor_surat}}" readonly ></input>
        <label>Tanggal Surat:</label> <input style="width: 70%;" value="{{$suratmasuk->tanggal_surat}}" readonly ></input>
        ...
        <label>Perihal:</label> <input style="width: 70%;" value="{{$suratmasuk->perihal}}" readonly ></input>
    </div>
